...
- Actualiza la versión de Zensical a [0.0.61](https://github.com/zensical/zensical/releases/tag/v0.0.61).
- Añade sección principal de «Entornos de desarrollo».

## Version 3.2.14

Publicada el 26-08-2026

- Actualiza la versión de Zensical a [0.0.57](https://github.com/zensical/zensical/releases/tag/v0.0.57).

## Version 3.2.13

Publicada el 18-07-2026

- Actualiza la versión de Zensical a [0.0.51](https://github.com/zensical/zensical/releases/tag/v0.0.51).
...
- Actualiza la versión de Zensical a [0.0.43](https://github.com/zensical/zensical/releases/tag/v0.0.43).
- Corrige enlaces rotos.

## Version 3.2.10

Publicada el 16-05-2026

- Actualiza la versión de Zensical a [0.0.42](https://github.com/zensical/zensical/releases/tag/v0.0.42).

## Version 3.2.9

Publicada el 14-05-2026

- Actualiza la versión de Zensical a [0.0.40](https://github.com/zensical/zensical/releases/tag/v0.0.40).
- Corrige enlaces rotos.

...
# Metodologías de desarrollo { #dev-methodologies }
...
### Principios fundamentales { #scrum-principles }
...
### Principios fundamentales { #kanban-principles }
...
![Kanban Board](./images/methodologies/kanban-board.png)

### Flujo continuo { #kanban-flow }
...
### Principios fundamentales { #extreme-principles }
...
### Prácticas principales { #extreme-practices }

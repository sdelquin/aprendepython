...
:one: [Marcado en plantillas](#mark-templates).  
:two: [Marcado en vistas](#mark-views).  
:three: [Marcado en URLs](#mark-urls).
...
```python title="main/urls.py" linenums="1" hl_lines="8 10"

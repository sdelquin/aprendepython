...
!!! tip "Migración de una aplicación"
    ...
    Si queremos crear/aplicar las migraciones de **una aplicación en concreto** podemos especificarlo en el mismo comando:
    ```console
...
1. [`null=True`](https://docs.djangoproject.com/en/stable/ref/models/fields/#null) :material-arrow-right-box: Indica que un valor «vacío» se almacenará en la base de datos como `#!sql NULL`.
2. [`blank=True`](https://docs.djangoproject.com/en/stable/ref/models/fields/#blank) :material-arrow-right-box: Indica que la validación Django permitirá la entrada de un valor «vacío».
...
A continuación veremos distintas operaciones que podemos llevar a cabo utilizando el ORM de Django.

### Creando objetos { #create-objects }

Para crear un nuevo objeto mediante el ORM de Django, podemos usar dos métodos:
...
=== "`save()`"
    ...
    1. Llamada al constructor del modelo.

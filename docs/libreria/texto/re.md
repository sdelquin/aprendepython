...
!!! tip "Cadenas en crudo"
    ...
    Cuando hay barras invertidas en la expresión regular (`\d`, `\s`, `\w`, `\b`, `\1`, ...) es recomendable el uso de [cadenas en crudo](../../fundamentos/tipos/cadenas.md#cadenas-en-crudo) o «raw strings» ya que de no hacerlo podríamos obtener errores del estilo: `#!python SyntaxWarning: invalid escape sequence '\d'`.
...
En su momento vimos el uso de la función [`split()`](../../fundamentos/estructuras/listas.md#dividir-string-como-lista) para cadenas de texto, pero era muy limitada para patrones avanzados. Veamos el uso de la función `re.split()` dentro de este módulo de expresiones regulares.
...
1. La [función «lambda»](../../fundamentos/modularidad/funciones.md#funciones-anonimas-lambda) recibe el objeto «matcheado» y realiza su modificación mediante los grupos de captura.
...
En este tipo de escenarios es habitual utilizar el [operador morsa](../../fundamentos/flujo/condicionales.md#operador-morsa) para discernir los casos a la vez que creamos una variable:
...
=== "Cadenas multilínea"
    ...
    Aquí utilizamos [cadenas multilínea](../../fundamentos/tipos/cadenas.md#comillas-triples) para construir la expresión regular:
    ...
    1. Es necesario pasar el flag [`re.VERBOSE`](https://docs.python.org/3/library/re.html#re.VERBOSE) para poder usar [cadenas multilínea](../../fundamentos/tipos/cadenas.md#comillas-triples). En su versión corta se puede escribir `#!python RE.X`
    
=== "f-strings"

    Aquí utilizamos [f-strings](../../fundamentos/tipos/cadenas.md#f-strings) para construir la expresión regular:
...
=== "f-strings multilínea"
    ...
    Aquí utilizamos [f-strings](../../fundamentos/tipos/cadenas.md#f-strings) dentro de una [cadena multilínea](../../fundamentos/tipos/cadenas.md#comillas-triples) para construir la expresión regular:
...
1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `vowel-words`
2. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `valid-float`
3. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `valid-email`
4. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `calc-from-str`
5. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `valid-url`

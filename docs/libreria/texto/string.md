...
El módulo [string](https://docs.python.org/es/3/library/string.html) proporciona **operaciones y constantes** muy útiles para manejo de [cadenas de texto](../../fundamentos/tipos/cadenas.md), además de distintas estrategias de **formateado de cadenas**.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `all-ascii`

## Plantillas

El módulo `string` también nos permite usar **plantillas con interpolación de variables**. Algo similar a los [f-strings](../../fundamentos/tipos/cadenas.md#f-strings) pero con otro tipo de sintaxis.
...
1. Podemos usar [argumentos nominales](../../fundamentos/modularidad/funciones.md#argumentos-nominales).
2. Podemos usar un [diccionario](../../fundamentos/estructuras/diccionarios.md).
...
A primera vista podría parecer que este sistema de plantillas no aporta gran ventaja sobre los [f-strings](../../fundamentos/tipos/cadenas.md#f-strings) que ya hemos visto. Sin embargo hay ocasiones en los que puede resultar muy útil.

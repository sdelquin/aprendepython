...
Para hacer una prueba inicial del intérprete vamos a retomar el primer programa que se suele hacer. Es el llamado [«Hello, World»](../desarrollo/maquina.md#ensamblador). Para ello escribimos lo siguiente en el intérprete y pulsamos la tecla ++enter++:

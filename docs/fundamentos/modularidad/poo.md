...
![Dark image](images/poo/bike-object-dark.svg#only-dark)
![Light image](images/poo/bike-object-light.svg#only-light)
...
![Dark image](images/poo/mold-dark.svg#only-dark)
![Light image](images/poo/mold-light.svg#only-light)
...
![Fork](images/poo/starwars-droids.jpg)
(1)
{ .annotate }
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `mobile-phone`
...
Mediante el [decorador](funciones.md#decoradores) `#!python @property` indicamos que un método se convierte en propiedad.
...
3. El [decorador](funciones.md#decoradores) `#!python @height.setter` hace que el método se llame cuando se asigne un valor al atributo `height`.
...
![Dark image](images/poo/obeys-owner1-dark.svg#only-dark)
![Light image](images/poo/obeys-owner1-light.svg#only-light)
...
![Dark image](images/poo/obeys-owner2-dark.svg#only-dark)
![Light image](images/poo/obeys-owner2-light.svg#only-light)
...
Es razonable plantearse cuándo usar [propiedades](#propiedades) o cuándo usar [métodos de instancia](#metodos-de-instancia). Si la implementación requiere de parámetros, no hay confusión, necesitamos usar métodos.
...
Un **método estático** es un método que ^^no «debería» modificar el estado del objeto ni de la clase^^. No recibe ningún parámetro especial. La identificación de estos métodos se completa aplicando el [decorador](funciones.md#decoradores) `#!python @staticmethod` a la función.
...
Hay escenarios en los que puede interesar aplicar decoradores propios en métodos de una clase. El enfoque es el mismo que ya se ha visto en la sección de [decoradores](funciones.md#decoradores) pero con ciertos matices. Un decorador dentro de una clase debe ser un **método estático**.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fraction`
...
![Inheritance](images/poo/inheritance.svg)
...
![Dark image](images/poo/multiple-inheritance-dark.svg#only-dark)
![Light image](images/poo/multiple-inheritance-light.svg#only-light)
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `file-inheritance`
...
-  **Agregación** 
    ...
    ![Agregación](images/poo/aggregation.svg)
...
-  **Composición** 
    ...
    ![Composición](images/poo/composition.svg)
...
Algunos ejemplos de secuencias que ya se han visto incluyen [cadenas de texto](../tipos/cadenas.md), [listas](../estructuras/listas.md) o [tuplas](../estructuras/tuplas.md).
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `infinite-list`
...
Hay muchos tipos de datos iterables en Python que ya se han estudiado: [cadenas de texto](../tipos/cadenas.md), [listas](../estructuras/listas.md), [tuplas](../estructuras/tuplas.md), [conjuntos](../estructuras/conjuntos.md), [diccionarios](../estructuras/diccionarios.md) o [ficheros](../estructuras/ficheros.md).
...
![Dark image](images/poo/iterables-dark.svg#only-dark)
![Light image](images/poo/iterables-light.svg#only-light)
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fibonacci-iterable`
...
1.  - Usamos una [expresión generadora](funciones.md#expresiones-generadoras) para construir los droides.
...
??? tip "Listas como iterables"
    ...
    A nivel de rendimiento y escalabilidad, hay que entender que no es lo mismo utilizar una [lista](../estructuras/listas.md) que un [generador](funciones.md#generadores), aunque en muchos escenarios puede ser más que suficiente.
    ...
    1.  - Usamos una [lista](../estructuras/listas.md) para construir los droides.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fibonacci-itergen`
...
1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `dna`
2. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `istack`
3. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `iqueue`
4. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `date`

...
![Banner](images/modulos/banner.jpg)
/// caption
...
![Librerías paquetes y módulos](images/modulos/library-package-module.svg)
...
![Paquete urllib](images/modulos/stdlib-package-module.svg)
...
1. Es necesario anteponer a la función `mean()` el [espacio de nombres](funciones.md#espacios-de-nombres) que define el módulo `stats`.
2. Es necesario anteponer a la función `std()` el [espacio de nombres](funciones.md#espacios-de-nombres) que define el módulo `stats`.
...
![Dark image](images/modulos/import-dark.svg#only-dark)
![Light image](images/modulos/import-light.svg#only-light)
...
El módulo `stats.py` ya se definió previamente [aquí](#importar-un-modulo-completo) y el código del módulo `ofrac.py` se presenta a continuación:
...
Cuando decidimos desarrollar un artefacto de software en Python, normalmente usamos distintos ficheros para ello. Algunos de esos ficheros se convertirán en [módulos](#modulos), otros se englobarán en [paquetes](#paquetes) y existirá uno en concreto que será nuestro **punto de entrada**, también llamado **programa principal**.
...
![Dark image](images/modulos/if-name-main-dark.svg#only-dark)
![Light image](images/modulos/if-name-main-light.svg#only-light)

...
![Banner](images/funciones/banner.jpg)
/// caption
...
![Dark image](images/funciones/def-dark.svg#only-dark)
![Light image](images/funciones/def-light.svg#only-light)
...
1.  - Los **nombres** de las funciones siguen [las mismas reglas que las variables](../tipos/datos.md#variables).
...
2. Nótese la [indentación](../flujo/condicionales.md#definicion-de-bloques) del _cuerpo_ de la función.
...
Por tanto, también podremos aplicar [desempaquetado de tuplas](../estructuras/tuplas.md#desempaquetado-de-tuplas) sobre el valor retornado por la función:
...
![Dark image](images/funciones/args-params-dark.svg#only-dark)
![Light image](images/funciones/args-params-light.svg#only-light)
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `sum-squares`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `factorial`
...
Python nos ofrece la posibilidad de **empaquetar y desempaquetar argumentos** cuando estamos invocando a una función, tanto para [argumentos posicionales](#argumentos-posicionales) como para [argumentos nominales](#argumentos-nominales), lo que facilita la gestión de número variable de argumentos.
...
=== "Argumentos sólo ^^nominales^^"
    ...
    ![Dark image](images/funciones/params-only-keywords-dark.svg#only-dark)
    ![Light image](images/funciones/params-only-keywords-light.svg#only-light)
...
=== "Argumentos sólo ^^posicionales^^"
    ...
    ![Dark image](images/funciones/params-only-positional-dark.svg#only-dark)
    ![Light image](images/funciones/params-only-positional-light.svg#only-light)
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `consecutive-freqs`
...
Ya hemos visto que en Python podemos incluir [comentarios](../flujo/condicionales.md#comentarios) para explicar mejor determinadas zonas de nuestro código.
...
Sin embargo la forma más ortodoxa de escribir un «docstring» es utilizando [triples comillas](../tipos/cadenas.md#comillas-triples):
...
Si preparamos un [proyecto sobre Sphinx](./files/funciones/docs.zip) y generamos la documentación, obtendremos algo similar a la siguiente página:

![Dark image](images/funciones/sphinx-docs-dark.png#only-dark)
![Light image](images/funciones/sphinx-docs-light.png#only-light)
...
Cuando trabajamos con funciones que pueden recibir un [número variable de argumentos](#numero-variable-de-argumentos) las anotaciones de tipo **sólo deben hacer referencia al tipo que contiene la tupla**, no es necesario indicar que se trata de una tupla (empaquetada).
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `mcount`
...
![Dark image](images/funciones/lambda-dark.svg#only-dark)
![Light image](images/funciones/lambda-light.svg#only-light)
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `order-by-age`

#### Enfoque funcional

Como ya se comentó [aquí](../../entornos/desarrollo/python.md#caracteristicas-del-lenguaje) Python es un lenguaje de programación **multiparadigma**. Uno de los paradigmas[^7]
...
![Dark image](images/funciones/map-filter-reduce-dark.svg#only-dark)
![Light image](images/funciones/map-filter-reduce-light.svg#only-light)
...
=== "`map()`"
    ...
    !!! tip "Lista por comprensión"
        ...
        Este comportamiento se puede implementar igualmente con una [lista por comprensión](../estructuras/listas.md#listas-por-comprension):
...
!!! quote "Código pitónico"
    ...
    Yo argumento que código pitónico implica adoptar el [desempaquetado de tuplas](../estructuras/tuplas.md#desempaquetado-de-tuplas), usar [listas por comprensión](../estructuras/listas.md#listas-por-comprension) cuando sea apropiado, usar [argumentos nominales](#argumentos-nominales) cuando tenga sentido, evitar el uso excesivo de clases, usar las [estructuras de iteración adecuadas](../flujo/bucles.md) o [evitar recorrer mediante índices](../estructuras/listas.md#iterar-sobre-una-lista).
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `genfun-squares`

#### Expresiones generadoras 

Una **expresión generadora** es sintácticamente muy similar a una [lista por comprensión](../estructuras/listas.md#listas-por-comprension), pero utilizamos ^^paréntesis^^ en vez de corchetes.

Podemos tratar de reproducir el <span class="example">ejemplo:material-flash:</span> visto en [funciones generadoras](#funciones-generadoras) donde se producían números pares:
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `genexp-squares`
...
Una **clausura** (del término inglés «closure») establece el uso de una [función interior](#funciones-interiores) que se genera dinámicamente y recuerda los valores de los argumentos con los que fue creada.
...
![Dark image](images/funciones/decorator-behaviour-dark.svg#only-dark)
![Light image](images/funciones/decorator-behaviour-light.svg#only-light)
...
1.  Cada función envuelve («wraps») a la siguiente:
    ...
    ![Decorator anatomy](images/funciones/decorator-anatomy.svg)
...
=== "$n$ argumentos"
    ...
    1. Los argumentos posicionales [se capturan](#numero-variable-de-argumentos) con `#!python *args`.
...
=== "$n$ argumentos (posicionales y nominales)"
    ...
    1.  - Los argumentos posicionales [se capturan](#numero-variable-de-argumentos) con `#!python *args`.
        - Los argumentos nominales [se capturan](#numero-variable-de-argumentos) con `#!python **kwargs`.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `deco-abs`
...
!!! info "Factoría de decoradores"
    ...
    Nótese que `my_decorator_with_params()` no es exactamente un decorador sino que es una _factoría de decoradores_ ([clausura](#clausuras)) que devuelve un decorador según los argumentos pasados.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `deco-sort`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `factorial-recursive`
...
![Dark image](images/funciones/namespaces-dark.svg#only-dark)
![Light image](images/funciones/namespaces-light.svg#only-light)
...
1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `num-in-interval`
2. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `extract-evens`
3. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `split-case`
4. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `perfect`
5. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `palindrome`
6. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `count-vowels-recursive`
7. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `pangram`
8. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `cycle-alphabet`
9. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `bubble-sort`
10. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `consecutive-seq`
11. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `magic-square`
12. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `nested-add`
13. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fibonacci-recursive`
14. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `hyperfactorial`
15. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fibonacci-generator`
16. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `palindrome-recursive`
17. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `deco-positive`
18. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `slice-recursive`

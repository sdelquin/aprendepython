...
![Banner](images/excepciones/banner.jpg)
/// caption
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `getint-iterative`

!!! exercise "Ejercicio"

    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `getint-recursive`
...
1. Lo que ocurre en este caso es una llamada implícita a `#!python err.__str__()` como se explicó [aquí](./poo.md#__str__).
...
Podemos «visitar» algunas [excepciones predefinidas](#excepciones-predefinidas) y comprobar este comportamiento:
...
1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `poker-card`

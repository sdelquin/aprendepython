...
![Banner](images/bucles/banner.jpg)
/// caption
...
2. Usando el [operador morsa](condicionales.md#operador-morsa) pedimos la entrada y comprobamos su valor.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `m5-limited`

## La sentencia `for`

Python permite recorrer aquellos tipos de datos que sean **iterables**, es decir, que admitan iterar[^2] sobre ellos. Algunos ejemplos de **tipos y estructuras de datos iterables** (_que permiten ser iteradas/recorridas_) son: [cadenas de texto](../tipos/cadenas.md), [listas](../estructuras/listas.md), [tuplas](../estructuras/tuplas.md), [diccionarios](../estructuras/diccionarios.md), [ficheros](../estructuras/ficheros.md), etc.
...
1.  - La variable `letter` va tomando cada uno de los elementos de `word`.
    - Dado que `word` es una _cadena de texto_, cada elemento es un [caracter](../tipos/cadenas.md#obtener-un-caracter).
...
Una sentencia `#!python break` dentro de un `#!python for` rompe el bucle, [igual que veíamos](#romper-un-bucle-while) para los bucles `#!python while`.
...
!!! tip "Comprobación de rotura y continuación"
    ...
    Tanto la [comprobación de rotura de un bucle](#comprobar-la-rotura) como la [continuación a la siguiente iteración](#continuar-un-bucle-while) se llevan a cabo del mismo modo que hemos visto con los bucles de tipo `#!python while`.

!!! exercise "Ejercicio"

    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `count-vowels`
...
La técnica para la generación de secuencias de números es muy similar a la utilizada en los [«slices»](../tipos/cadenas.md#trocear-una-cadena) de cadenas de texto. En este caso disponemos de la función `#!python range(start, stop, step)`:
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `prime`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `pow`

## Bucles anidados

Como ya vimos en las [sentencias condicionales](condicionales.md#la-sentencia-if), el **anidamiento** es una técnica por la que incluimos distintos niveles de encapsulamiento de sentencias, unas dentro de otras, con mayor nivel de profundidad.

En el caso de los bucles también es posible hacer anidamiento, tanto para bucles [`while`](#la-sentencia-while) como para bucles [`for`](#la-sentencia-for).

![Matrioskas](images/bucles/matrioskas.png)
///caption
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `mosaic`

## Ejercicios

1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `letdig`
2. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `m3-sum-limited`
3. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `repeat-please`
4. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `one-tree`
5. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `chess-horse`
6. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `domino`
7. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fmin`
8. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `ascii-table`
9. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `guess-number`
10. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `gcd`
11. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `hamming`
12. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `cartesian`
13. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `cumprod-sq`
14. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `isalpha`
15. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `kpower`
16. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fibonacci`

...
![Banner](images/condicionales/banner.jpg)
/// caption
...
A diferencia de otros lenguajes que utilizan _llaves_ para definir los bloques de código (véase C o Java), cuando Guido Van Rossum [diseñó Python](../../entornos/desarrollo/python.md#python) quiso evitar estos caracteres por considerarlos innecesarios.
...
![Dark image](images/condicionales/four-spaces-dark.svg#only-dark)
![Light image](images/condicionales/four-spaces-light.svg#only-light)
...
![Dark image](images/condicionales/elif-dark.svg#only-dark)
![Light image](images/condicionales/elif-light.svg#only-light)
...
![Tablas de la verdad](images/condicionales/truth-tables.svg)

!!! exercise "Ejercicio"

    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `leap-year`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `marvel-akinator`
...
Cuando trabajamos con expresiones que incorporan valores «booleanos», se produce una [conversión implícita](../tipos/numeros.md#conversion-implicita) que transforma los tipos de datos involucrados a valores `#!python True` o `#!python False`.
...
Es posible utilizar [operadores lógicos](#operadores-logicos) en sentencias de asignación sacando partido de las tablas de la verdad que funcionan para estos casos.
...
=== "Asignación mediante AND :material-gate-and:"
    ...
    1. Se trata de una expresión lógica en la que se aplica conversión implícita de los valores enteros a valores «booleanos». En este sentido el valor de `b` evalúa a `#!python False` ya que es 0. Al estar usando un operador `#!python and` se produce un [cortocircuito lógico:material-flash-outline:](#cortocircuito-logico) y se asigna el valor de la `b` a la variable `a`.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `simple-op`
...
Vamos a plantear un <span class="example">ejemplo:material-flash:</span> donde partimos de una [tupla](../estructuras/tuplas.md) que representará un punto en el plano (2 coordenadas) o en el espacio (3 coordenadas). Lo primero que vamos a hacer es detectar en qué dimensión se encuentra el punto:
...
1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `rps`
2. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `min3values`
3. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `blood-donation`
4. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `facemoji`
5. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `shortcuts`

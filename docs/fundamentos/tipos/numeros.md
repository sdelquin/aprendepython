...
![Banner](images/numeros/banner.jpg)
/// caption
...
!!! failure "Atención"
    ...
    Tal y como se explicó en [este apartado](datos.md#reglas-para-nombrar-variables), los nombres de variables son «case-sensitive». De igual modo el tipo booleano toma valores `True` y `False` con **la primera letra en mayúsculas**. De no ser así obtendríamos un error sintáctico.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `add`
...
![Modulo](images/numeros/modulo-dark.svg#only-dark)
![Modulo](images/numeros/modulo-light.svg#only-light)
...
=== "a) Dividendo :material-code-less-than: divisor"
    ...
    ![](images/numeros/coil-modulo1-dark.svg#only-dark)
    ![](images/numeros/coil-modulo1-light.svg#only-light)
...
=== "b) Dividendo :material-equal-box: divisor"
    ...
    ![](images/numeros/coil-modulo2-dark.svg#only-dark)
    ![](images/numeros/coil-modulo2-light.svg#only-light)
...
=== "c) Dividendo :material-code-greater-than: divisor"
    ...
    ![](images/numeros/coil-modulo3-dark.svg#only-dark)
    ![](images/numeros/coil-modulo3-light.svg#only-light)
...
=== "Desplazamiento con paso 1"
    ...
    ![Dark image](images/numeros/circular-shift-step1-dark.svg#only-dark)
    ![Light image](images/numeros/circular-shift-step1-light.svg#only-light)
...
=== "Desplazamiento con paso 3"
    ...
    ![Dark image](images/numeros/circular-shift-step3-dark.svg#only-dark)
    ![Light image](images/numeros/circular-shift-step3-light.svg#only-light)
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `quadratic`
...
1. A diferencia de los [números enteros](#enteros), los valores flotantes ^^sí pueden^^ empezar por 0.
...
- `bool()` convierte al tipo [booleano](#booleanos).
- `int()` convierte al tipo [entero](#enteros).
- `float()` convierte al tipo [flotante](#flotantes).
...
Para **obtener el tipo** de una variable [ya hemos visto](datos.md#conocer-el-tipo-de-una-variable) la función `#!python type()`:
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `sin-approx`
...
=== "Función: `#!python bin()`"
    ...
    !!! danger "Resultado"
        ...
        Esta función devuelve una [cadena de texto](cadenas.md).
...
1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `circle-area`
2. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `sphere-volume`
3. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `triangle-area`
4. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `interest-rate`
5. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `euclid-distance`
6. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `century-year`
7. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `red-square`
7. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `igic`
8. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `super-fast`
9. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `move-twice`
10. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `pillars`
11. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `clock-time`
13. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `ring-area`

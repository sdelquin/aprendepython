...
![Banner](images/datos/banner.jpg)
/// caption
...
![PyObject](images/datos/pyobject.svg)
...
| --- | --- | --- |
| Booleano | [`bool`](numeros.md#booleanos) | `#!python True`, `#!python False`
| Entero | [`int`](numeros.md#enteros) | `#!python 21`, `#!python 34500`, `#!python 34_500`
| Flotante | [`float`](numeros.md#flotantes) | `#!python 3.14`, `#!python 0.00314e3`
| Complejo | `#!python complex` | `#!python 2j`, `#!python 3+5j`
| Cadena | [`str`](cadenas.md) | `#!python 'tfn'`, `#!python "tenerife"`
| Tupla | [`tuple`](../estructuras/tuplas.md) | `#!python (1, 3, 5)`
| Lista | [`list`](../estructuras/listas.md) | `#!python ['Chrome', 'Firefox', 'Safari']`
| Conjunto | [`set`](../estructuras/conjuntos.md) | `#!python {2, 4, 6}`
| Diccionario | [`dict`](../estructuras/diccionarios.md) | `#!python {'Spiderman': 'Marvel', 'Superman': 'DC'}`
...
- Usar **verbos** para los nombres de [funciones](../modularidad/funciones.md) :material-arrow-right: `get_article()`
- Usar **adjetivos** para los nombres de [booleanos](numeros.md#booleanos) :material-arrow-right: `available`
...
Recordemos que los nombres de variables deben seguir unas [reglas establecidas](#reglas-para-nombrar-variables), de lo contrario obtendremos un error sintáctico del intérprete de Python:
...
![Inmutable 1](images/datos/inmutable1.svg)
...
![Inmutable 2](images/datos/inmutable2.svg)
...
![Inmutable 3](images/datos/inmutable3.svg)
...
![Mutable 1](images/datos/mutable1.svg)
...
![Mutable 2](images/datos/mutable2.svg)
...
![Mutable 3](images/datos/mutable3.svg)
...
Hemos ido usando una serie de [funciones](../modularidad/funciones.md) sin ser especialmente conscientes de ello. Esto se debe a que son funciones «built-in» o incorporadas por defecto en el propio lenguaje Python.
...
[^1]: Ya en 1946, John Von Neuman [propuso](../../entornos/desarrollo/historia.md#hitos-de-la-computacion) guardar en memoria no sólo los datos sino también el código.

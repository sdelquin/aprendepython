...
![Banner](images/conjuntos/banner.jpg)
/// caption
...
!!! warning "Orden"
    ...
    Python [almacena los conjuntos](https://www.reddit.com/r/learnpython/comments/1b0aama/comment/ks7bjvm/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button) ordenados según [el valor «hash»](diccionarios.md#objetos-hashables) de sus elementos. Pero esto es únicamente un «detalle de implementación» en el que no se puede confiar.[^1]
...
!!! warning "Recordatorio"
    ...
    No confundir la función [`append()`](listas.md#anadir-al-final-de-la-lista) de las listas con la función `#!python add()` de los conjuntos. Ambas sirve para añadir elementos pero en estructuras de diferente naturaleza.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `tuple-set`
...
Si tratamos de **borrar un elemento que no existe** obrendremos un `#!python KeyError` (al igual que ocurría en los [diccionarios](diccionarios.md#obtener-un-elemento)):
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `diverse-word`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `half-out`
...
![Dark image](images/conjuntos/venn-dark.svg#only-dark)
![Light image](images/conjuntos/venn-light.svg#only-light)
...
-   **Intersección** :material-set-center: $A \cap B$
    ...
    ![Dark image](images/conjuntos/venn-intersection-dark.svg#only-dark)
    ![Light image](images/conjuntos/venn-intersection-light.svg#only-light)
...
-   **Unión** :material-set-all: $A \cup B$
    ...
    ![Dark image](images/conjuntos/venn-union-dark.svg#only-dark)
    ![Light image](images/conjuntos/venn-union-light.svg#only-light)
...
-   **Diferencia** :material-set-left: $A \setminus B$
    ...
    ![Dark image](images/conjuntos/venn-difference-dark.svg#only-dark)
    ![Light image](images/conjuntos/venn-difference-light.svg#only-light)
...
-   **Diferencia simétrica** :material-set-left-right: $A \triangle B$
    ...
    ![Dark image](images/conjuntos/venn-symdiff-dark.svg#only-dark)
    ![Light image](images/conjuntos/venn-symdiff-light.svg#only-light)
...
-   **Subconjunto** $B \subset A$
    ...
    ![Subset](images/conjuntos/inclusion.svg)
...
Los conjuntos, al igual que las [listas](listas.md#listas-por-comprension) y los [diccionarios](diccionarios.md#diccionarios-por-comprension), también se pueden crear por **comprensión**.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `common-consonants`
...
La única restricción que deben cumplir los elementos de un conjunto es ser [hashables](diccionarios.md#objetos-hashables). Un objeto es «hashable» si se le puede asignar un valor «hash» que no cambia en ejecución durante toda su vida.
...
Si intentamos añadir una [lista](listas.md) como clave de un diccionario obtendremos el siguiente error:
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `is-binary`

...
![Banner](images/listas/banner.jpg)
/// caption
...
1. Una lista de 3 [cadenas de texto](../tipos/cadenas.md).
2. Una lista de 8 [números enteros](../tipos/numeros.md#enteros).
...
Otro <span class="example">ejemplo:material-flash:</span> interesante de conversión puede ser la de los [rangos](../flujo/bucles.md#secuencias-de-numeros). En este caso queremos obtener una **lista explícita** con los valores que constituyen el rango $[0,9]$:
...
Igual que en el caso de las [cadenas de texto](../tipos/cadenas.md), podemos obtener un elemento de una lista a través del **índice** (lugar) que ocupa. Veamos un <span class="example">ejemplo:material-flash:</span>:
...
El **índice** que usemos para acceder a los elementos de una lista tiene que estar ^^comprendido entre los límites^^ de la misma. Si usamos un índice antes del comienzo o después del final obtendremos un error ([excepción](../modularidad/excepciones.md)):
...
El troceado de listas funciona de manera totalmente análoga al [troceado de cadenas](../tipos/cadenas.md#trocear-una-cadena). Veamos algunos <span class="example">ejemplos:material-flash:</span>:
...
=== "Conservando la lista original :material-texture-box:"
    ...
    - **Opcion A**{ .pink } :material-arrow-right-box: Mediante [troceado de listas](#trocear-una-lista) con «step» negativo:
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `slicerev`
...
Al igual que ocurría con el [troceado de listas](#trocear-una-lista), en este tipo de inserciones no obtendremos un error si especificamos índices fuera de los límites de la lista. Estos se ajustarán al principio o al final en función del valor que indiquemos:
...
!!! abstract "append vs insert"
    ...
    :material-alarm-light-off-outline:{ .red } ¡No lo hagas! Utiliza [`append()`](#anadir-al-final-de-la-lista) :material-arrow-right-box: Es más eficiente y más legible.

### Repetir elementos

Al igual que con las [cadenas de texto](../tipos/cadenas.md#repetir-cadenas), el operador `#!python *` nos permite repetir los elementos de una lista.
...
=== "Por su rango :fontawesome-solid-pizza-slice:"
    ...
    Mediante [troceado de listas](#trocear-una-lista):
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `qletters`
...
!!! warning "No existe `find`"
    ...
    En listas no disponemos de la función `find()` que sí estaba disponible para [cadenas de texto](../tipos/cadenas.md#realizar-busquedas).
...
!!! note "Valor booleano"
    ...
    El operador `in` siempre devuelve un [valor booleano](../tipos/numeros.md#booleanos), es decir, verdadero o falso.

!!! exercise "Ejercicio"

    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `isogram`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `num-words`
...
![Dark image](images/listas/join-list-dark.svg#only-dark)
![Light image](images/listas/join-list-light.svg#only-light)
...
??? tip "join vs split"
    ...
    La función `join()` es realmente la **opuesta** a la función [split()](#dividir-string-como-lista).

!!! exercise "Ejercicio"

    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fix-date`
...
Al igual que [hemos visto con las cadenas de texto](../flujo/bucles.md#la-sentencia-for), también podemos iterar sobre los elementos de una lista utilizando la sentencia `for`.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `chars-list`
...
![Zip diagram](images/listas/zip.svg)
...
1. Formalmente lo que devuelve `#!python zip()` son [tuplas](tuplas.md), en este caso «envueltas» en una lista.

!!! exercise "Ejercicio"

    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `dot-product`
...
!!! abstract "Ver también"
    ...
    Esta comparación funciona de forma totalmente análoga a la [comparación de cadenas de texto](../tipos/cadenas.md#comparar-cadenas).

## Cuidado con las copias

Las listas son [estructuras de datos mutables](../tipos/datos.md#mutabilidad) y esta característica nos obliga a tener cuidado cuando realizamos copias de listas, ya que la modificación de una de ellas puede afectar a la otra.
...
![Dark image](images/listas/list-comprehension-dark.svg#only-dark)
![Light image](images/listas/list-comprehension-light.svg#only-light)
...
![Transformation of list comprehensions](./images/listas/list-comprehensions-transformation.svg)
...
En la iteración que usamos dentro de la lista por comprensión es posible usar [bucles anidados](../flujo/bucles.md#bucles-anidados).
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fcomp`
...
![Dark image](images/listas/sys-argv-dark.svg#only-dark)
![Light image](images/listas/sys-argv-light.svg#only-light)
...
!!! exercise "Ejercicio"
    ...
    Escribe un programa `avg.py` que reciba [desde línea de comandos](#sysargv) una serie de números y calcule la **media de dichos valores** (_redondeando a 2 cifras decimales_).
    ...
    **Ejemplo:**
    ...
    :octicons-light-bulb-16:{ .yellow } Ten en cuenta que `sys.argv` es una lista (como otra cualquiera) y que admite [troceado de listas](#trocear-una-lista).
...
![Campeonas 2023](./images/listas/spain2023-worldchampions.svg)
///caption
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `mul-matrix2`

## Ejercicios

1. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `max-value`
2. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `max-value-with-min`
3. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `min-value`
4. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `min-value-with-max`
5. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `remove-dups`
6. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `flatten-list`
7. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `remove-consecutive-dups`
8. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `all-same`
9. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `sum-diagonal`
10. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `powers2`
11. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `sum-mixed`
12. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `n-multiples`
13. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `drop-even`
14. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `nth-power`
15. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `name-initials`
16. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `non-consecutive`
17. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `mul-reduce`
18. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `digit-rev-list`
19. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `time-plus-minutes`
20. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `add-positives`
21. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `add-opposites`
22. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `descending-numbers`
23. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `merge-sorted`
24. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `trimmed-add`
25. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `wolves`
26. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `minmax`
27. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `cascading-subsets`
28. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `diff-cuboid`
29. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fl-strip`
30. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `logical-chain`
31. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `first-unused-id`
32. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `find-odds`
33. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `chemistry`
34. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `next-item`
35. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `v-partition`
36. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `attach-len`
37. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `reversing-words`
38. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `barycenter`
39. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `sort-custom`
40. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `flatten-list-deep`
41. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `first-duplicated`
42. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fill-values`
43. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `frange`
44. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `qual-name`
45. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `mul-matrix`


[^1]: Más adelante veremos el comportamiento de las [funciones](../modularidad/funciones.md). Devolver o retornar un valor es el resultado de aplicar una función.
[^2]: Existen multitud de paquetes científicos en Python para trabajar con listas o vectores numéricos. Una de las más famosas es la librería [Numpy](../../paquetes/ciencia-datos/numpy.md).

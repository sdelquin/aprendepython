...
![Banner](images/diccionarios/banner.jpg)
///caption
...
![Dark image](images/diccionarios/dicts-dark.svg#only-dark)
![Light image](images/diccionarios/dicts-light.svg#only-light)
...
!!! note "Hashes"
    ...
    En otros lenguajes de programación, a los diccionarios se les conoce como _arrays asociativos_, _«hashes»_ o _«hashmaps»_. Básicamente porque al final lo que utilizan es una [función hash](#objetos-hashables) para determinar la ubicación de las claves.
...
1. Un diccionario con claves [cadenas de texto](../tipos/cadenas.md) y valores [cadenas de texto](../tipos/cadenas.md).
2. Un diccionario con claves [números enteros](../tipos/numeros.md#enteros) y valores [números enteros](../tipos/numeros.md#enteros).
...
A continuación se muestra un <span class="example">ejemplo:material-flash:</span> de creación de un diccionario donde las **claves** son las **letras vocales** y los **valores** son sus [códigos UNICODE](../tipos/cadenas.md#caracteres-unicode):
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `extract-cities`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `count-letters`
...
=== "Obtener claves y valores :octicons-key-16::material-content-save:"
    ...
    :material-check-all:{ .blue } Cabe destacar que los «items» se devuelven como una **[lista](listas.md) de [tuplas](tuplas.md)**, donde cada tupla contiene dos elementos: el primero representa la **clave** y el segundo representa el **valor**.

### Iterar sobre un diccionario

En función de los [elementos que podemos obtener](#obtener-un-elemento), Python proporciona tres maneras de iterar sobre un diccionario:
...
=== "Iterar sobre claves y valores :octicons-key-16::material-content-save:"
    ...
    1. Aquí se produce un [desempaquetado de tuplas](tuplas.md#desempaquetado-de-tuplas) en cada iteración del bucle.
    2. Recuerda el uso de los [«f-strings»](../../fundamentos/tipos/cadenas.md#f-strings) para formatear cadenas de texto.

!!! exercise "Ejercicio"

    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `avg-population`
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `merge-dicts`
...
Al igual que [ocurría con las listas](listas.md#cuidado-con-las-copias), si hacemos un cambio en un diccionario, se verá reflejado en todas las variables que hagan referencia al mismo. Esto se deriva de su propiedad de ser _mutable_.
...
De forma análoga a cómo se escriben las [listas por comprensión](listas.md#listas-por-comprension), podemos aplicar este método a los diccionarios usando llaves `{ }`.
...
!!! exercise "Ejercicio"
    ...
    [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `split-marks`
...
1.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `group-words`
2.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `same-dict-values`
3.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `dict-from-list`
4.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `clear-dict-values`
5.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fix-keys`
6.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `order-stock`
7.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `inventory-updates`
8.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `sort-dict`
9.  [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `money-back`
10. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `money-back-max`
11. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `first-ntimes`
12. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `fix-id`
13. [pypas](../../paquetes/aprendizaje/pypas.md) &nbsp;:fontawesome-solid-hand-holding-heart:{ .acc .slide } `dict-pull`

...
1. Utilizamos [expresiones regulares](../../libreria/texto/re.md) para resolver este problema.
...
Simplificando, podríamos decir que cada elemento de la famosa «sopa» de _Beautiful Soup_ puede ser un [`bs4.element.Tag`](https://www.crummy.com/software/BeautifulSoup/bs4/doc/api/bs4.html#bs4.Tag) o un «[string](../../fundamentos/tipos/cadenas.md)».
...
=== "`.text`"
    ...
    Devuelve una [cadena de texto](../../fundamentos/tipos/cadenas.md) con todos los contenidos textuales del elemento incluyendo espacios y saltos de línea.
...
=== "`.strings`"
    ...
    Devuelve un [generador](../../fundamentos/modularidad/funciones.md#generadores) de todos los contenidos textuales del elemento incluyendo espacios y saltos de línea.
...
=== "`.stripped_strings`"
    ...
    Devuelve un [generador](../../fundamentos/modularidad/funciones.md#generadores) de todos los contenidos textuales del elemento eliminando espacios y saltos de línea.
...
=== "`.string`"
    ...
    Devuelve una [cadena de texto](../../fundamentos/tipos/cadenas.md) con el contenido dele elemento, siempre que contenga un único elemento textual.
...
Si no se quiere explicitar el contenido de un elemento como lista, también es posible usar un [generador](../../fundamentos/modularidad/funciones.md#generadores) para **acceder al mismo de forma secuencial**:
...
!!! exercise "Ejercicio"
    ...
    Se recomienda usar el paquete [`requests`](../redes/requests.md) para obtener el código fuente de la página. Hay que tener en cuenta que el listado de paquetes cambia cada pocos segundos, a efectos de comprobación.

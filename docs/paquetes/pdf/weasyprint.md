...
=== "Aplicaciones web"
    ...
    !!! tip "Django"
        ...
        En [Django](../web/django/desarrollo-web.md#django) podemos utilizar la función [`request.build_absolute_uri()`](https://docs.djangoproject.com/en/stable/ref/request-response/#django.http.HttpRequest.build_absolute_uri) para este cometido:

...
El módulo [`jupyter`](https://jupyter.org/) proporciona un **entorno de desarrollo integrado** para ciencia de datos (incluso generalista), que no es exclusivo de Python, sino que además admite otros lenguajes ([«kernels»](#menu-kernel)) en su «backend».
...
=== "`jupyter lab`"
    ...
    Lanza un [servidor «vitaminado»](#jupyter-lab) en http://localhost:8888
...
- [x] Texto en formato [Markdown](https://www.markdownguide.org/basic-syntax/) (incluyendo [fórmulas](#ejemplos-de-formulas)).
- [x] Código Python.

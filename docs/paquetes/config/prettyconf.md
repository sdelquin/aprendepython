...
| --- | --- | --- | --- |
| `config.boolean` | Convierte a [booleano](../../fundamentos/tipos/numeros.md#booleanos)(1) | `#!python 'On'` | `#!python config(ITEM, cast=config.boolean)` :material-arrow-right-box: `#!python True`
| `config.list` | Convierte a [lista](../../fundamentos/estructuras/listas.md)(2) | `#!python 'A,B,C'` | `#!python config(ITEM, cast=config.list)` :material-arrow-right-box: `#!python ['A','B','C']`
| `config.tuple` | Convierte a [tupla](../../fundamentos/estructuras/tuplas.md)(3) | `#!python 'A,B,C'` | `#!python config(ITEM, cast=config.tuple)` :material-arrow-right-box: `#!python ('A','B','C')`
...
1. Es habitual usar [funciones anónimas lambda](../../fundamentos/modularidad/funciones.md#funciones-anonimas-lambda) para estos propósitos.

...
- [x] [Marcado en plantillas](#marcado-en-plantillas).  
- [x] [Marcado en vistas](#marcado-en-vistas).  
- [x] [Marcado en URLs](#marcado-en-urls).

### Marcado en plantillas

Podemos «marcar» para traducción cadenas de texto en plantillas. Para ello, Django nos ofrece la [etiqueta de plantilla](plantillas.md#etiquetas): [`translate`](https://docs.djangoproject.com/en/stable/topics/i18n/translation/#translate-template-tag).
...
??? abstract "justfile"
    ...
    Consulta la receta [`makelocale`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
=== "*uv* &nbsp;:simple-uv:{.uv}"
    ...
    ??? abstract "justfile"
        ...
        Consulta la receta [`makemessages`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
??? example "Poedit"
    ...
    ??? abstract "justfile"
        ...
        Consulta la receta [`poedit`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
=== "*uv* &nbsp;:simple-uv:{.uv}"
    ...
    ??? abstract "justfile"
        ...
        Consulta la receta [`compilemessages`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
- Entre otras, tendríamos `/en/posts/add/` o `/es/posts/add/` que si aplicamos [marcado](#marcado) y [traducción](#traduccion) de URLs, podría convertirse en `/es/posts/agregar/`

### Etiqueta personalizada

Veamos ahora una posible implementación de una [etiqueta personalizada](plantillas.md#etiquetas-personalizadas) para el **cambio de idioma** que hace uso de la vista `set_language` proporcionada por Django *i18n*:

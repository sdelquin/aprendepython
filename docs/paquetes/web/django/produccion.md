...
Una posible aproximación es utilizar el paquete [`prettyconf`](../../../paquetes/config/prettyconf.md) y parametrizar el valor de la variable `DEBUG`:
...
Una posible aproximación es utilizar el paquete [`prettyconf`](../../../paquetes/config/prettyconf.md) y parametrizar la URL de la interfaz administrativa:
...
Una posible aproximación es utilizar el paquete [`prettyconf`](../../../paquetes/config/prettyconf.md) y parametrizar el valor de la variable `SECRET_KEY`:
...
??? abstract "justfile"
    ...
    Consulta la receta [`secret-key`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
Una posible aproximación es utilizar el paquete [`prettyconf`](../../../paquetes/config/prettyconf.md) y parametrizar el valor de la variable `ALLOWED_HOSTS`:

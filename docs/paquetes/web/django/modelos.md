...
Como hemos visto en las [características de Django](../django/desarrollo-web.md#django) existe un **ORM** que vincula tablas de la base de datos con objetos de Python.
...
Un modelo no es más que una clase Python que «suele» vivir en el fichero `models.py` de una [aplicación](aplicaciones.md) Django.

Veamos un <span class="example">ejemplo:material-flash:</span> en el que creamos un modelo `Post` de nuestro «blog» dentro de una [aplicación](aplicaciones.md#crear-una-aplicacion) llamada `posts`:
...
!!! tip "Campos obligatorios"
    ...
    Todos los campos que definimos en un modelo son **campos obligatorios** (requeridos) por defecto, salvo que se [indique lo contrario](#campos-opcionales) de forma explícita.
...
| --- | --- | --- | --- |
| [`AutoField`:fontawesome-solid-arrow-up-right-dots:](https://docs.djangoproject.com/en/stable/ref/models/fields/#autofield) | Entero autoincremental | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`BigAutoField`:fontawesome-solid-arrow-up-right-dots:](https://docs.djangoproject.com/en/stable/ref/models/fields/#bigautofield) | Entero largo  (_64bits_)<br>autoincremental | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`BigIntegerField`:material-lightning-bolt:](https://docs.djangoproject.com/en/stable/ref/models/fields/#bigintegerfield) | Entero largo (_64bits_) | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
...
| [`BooleanField`:material-sort-bool-descending:](https://docs.djangoproject.com/en/stable/ref/models/fields/#booleanfield) | Valor «booleano» | [`bool`](../../../fundamentos/tipos/numeros.md#booleanos) | |
| [`CharField`:material-text-short:](https://docs.djangoproject.com/en/stable/ref/models/fields/#charfield) | Campo de texto (corto) | [`str`](../../../fundamentos/tipos/cadenas.md) | `max_length`:octicons-key-asterisk-24:{ .yellow } (2) |
...
| [`EmailField`:material-email-box:](https://docs.djangoproject.com/en/stable/ref/models/fields/#emailfield) | Correo electrónico | [`str`](../../../fundamentos/tipos/cadenas.md) | `max_length`(9) |
...
| [`FilePathField`:material-folder-hidden:](https://docs.djangoproject.com/en/stable/ref/models/fields/#filepathfield) | Nombres de ficheros existentes en una ruta | [`str`](../../../fundamentos/tipos/cadenas.md) | `path`:octicons-key-asterisk-16:{ .red } (13)<br>`match`(14)<br>`recursive`(15)<br>`allow_files`(16)<br>`allow_folders`(17)<br>`max_length`(18) |
| [`FloatField`:octicons-number-24:](https://docs.djangoproject.com/en/stable/ref/models/fields/#floatfield) | Valor flotante | [`float`](../../../fundamentos/tipos/numeros.md#flotantes) | |
...
| [`GenericIPAddressField`:material-ip-network:](https://docs.djangoproject.com/en/stable/ref/models/fields/#genericipaddressfield) | Dirección IPv4 o IPv6 | [`str`](../../../fundamentos/tipos/cadenas.md) | `protocol`(22)<br>`unpack_ipv4`(23) |
...
| [`IntegerField`:octicons-number-24:](https://docs.djangoproject.com/en/stable/ref/models/fields/#integerfield) | Valor entero | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`JSONField`:material-code-json:](https://docs.djangoproject.com/en/stable/ref/models/fields/#jsonfield) | Datos JSON | [`dict`](../../../fundamentos/estructuras/diccionarios.md) o [`list`](../../../fundamentos/estructuras/listas.md) | `encoder`(28)<br>`decoder`(29) |
| [`PositiveBigIntegerField`:octicons-number-24:](https://docs.djangoproject.com/en/stable/ref/models/fields/#positivebigintegerfield) | Entero positivo largo | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`PositiveIntegerField`:octicons-number-24:](https://docs.djangoproject.com/en/stable/ref/models/fields/#positiveintegerfield) | Entero positivo | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`PositiveSmallIntegerField`:octicons-number-24:](https://docs.djangoproject.com/en/stable/ref/models/fields/#positivesmallintegerfield) | Entero positivo corto | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`SlugField`:fontawesome-solid-link:](https://docs.djangoproject.com/en/stable/ref/models/fields/#slugfield) | «Slug»[^2] | [`str`](../../../fundamentos/tipos/cadenas.md) | `max_length`(30) |
| [`SmallAutoField`:fontawesome-solid-arrow-up-right-dots:](https://docs.djangoproject.com/en/stable/ref/models/fields/#smallautofield) | Entero corto autoincremental | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`SmallIntegerField`:fontawesome-solid-arrow-up-right-dots:](https://docs.djangoproject.com/en/stable/ref/models/fields/#smallintegerfield) | Entero corto | [`int`](../../../fundamentos/tipos/numeros.md#enteros) | |
| [`TextField`:material-text-long:](https://docs.djangoproject.com/en/stable/ref/models/fields/#textfield) | Campo de texto (largo) | [`str`](../../../fundamentos/tipos/cadenas.md) | |
...
| [`URLField`:material-web:](https://docs.djangoproject.com/en/stable/ref/models/fields/#urlfield) | URL | [`str`](../../../fundamentos/tipos/cadenas.md) | `max_length`(33) |
...
=== ":one: Crear migración"
    ...
    === "*uv* &nbsp;:simple-uv:{.uv}"
        ...
        ??? abstract "justfile"
            ...
            Consulta la receta [`makemigrations`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
=== "*uv* &nbsp;:simple-uv:{.uv}"
    ...
    ??? abstract "justfile"
        ...
        Consulta la receta [`showmigrations`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
Si visualizamos el [registro de migraciones](#registro-de-migraciones) veremos que esta última migración ya se ha aplicado:
...
Para disponer de **datos iniciales** en la base de datos, descargamos este fichero [`posts.json`](files/modelos/posts.json) y [cargamos las «fixtures»](#cargar-fixtures):
...
Como ya se introdujo en las [características de Django](desarrollo-web.md#django) el ORM (Object-Relational Mapper) es la herramienta que permite interactuar con bases de datos usando objetos y clases de Python en lugar de escribir directamente consultas SQL.
...
=== "*uv* &nbsp;:simple-uv:{.uv}"
    ...
    ??? abstract "justfile"
        ...
        Consulta la receta [`shell`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
=== "*uv* &nbsp;:simple-uv:{.uv}"
    ...
    ??? abstract "justfile"
        ...
        Consulta la receta [`dbshell`](justfile.md#justfile-para-django) para incluirla en tu `justfile`.
...
??? abstract "justfile (para comando)"
    ...
    También dispones de la receta [`dbcmd`](justfile.md#justfile-para-django) que permite ejecutar directamente un comando sobre la base de datos sin necesidad de entrar en el cliente. Por <span class="example">ejemplo:material-flash:</span>:
...
La forma más «obvia» de recuperar un objeto de modelo es mediante su [clave primaria](#clave-primaria).
...
1. También funciona para [`get()`](#un-unico-objeto) y para [`exclude()`](#excluyendo-objetos).
...
1.  - El método devuelve el número de objetos afectados.
    ...
    - Obviamente también se puede utilizar sobre una operación de [filtrado](#ciertos-objetos).
...
:one: Tipos enumerados basados en **cadenas de texto** → [Enumerados textuales](#enumerados-textuales).  
:two: Tipos enumerados basados en **números enteros** → [Enumerados enteros](#enumerados-enteros).
...
:one: [Modelo relacionado](#nombre-relacionado)  
:two: [Nombre relacionado](#nombre-relacionado)  
:three: [Acción de borrado](#accion-de-borrado) 
...
Es muy habitual relacionar modelos con la clase [`User`](autenticacion.md#usuario) predefinida en Django. No es distinto de lo que hemos visto hasta ahora, pero sí vale la pena indicar cómo se referencia.
...
1. Consulta [acceso al modelo de usuario](autenticacion.md#usuario).
...
=== "Borrado :material-delete:"
    ...
    1. Utilizamos [`related-name`](#nombre-relacionado) para acceder a la *relación inversa*.
    ...
    1. Esto sólo se podrá hacer si pueden existir comentarios "húerfanos" (consultar [claves ajenas nulas](#claves-ajenas-nulas)).
...
Dado que no tenemos acceso «directo» a modificar el modelo [`User`](autenticacion.md#usuario) predefinido en Django hay que buscar [otras alternativas](https://medium.com/@karimdhrif4444/mastering-user-management-comprehensive-guide-to-extending-djangos-user-model-51c2ccd793d4) para extender dicho modelo.
...
Como se puede observar, se trata de una relación `1:1` por lo que vamos a utilizar la clase [`OneToOneField()`](#relaciones-uno-a-uno) que proporciona Django. La implementación sería la siguiente:
...
1. Se podría poner directamente `#!python 'auth.User'` aunque este acceso [está más desacoplado](autenticacion.md#usuario).
...
3. El parámetro `related_name` funciona igual que en [casos anteriores](#nombre-relacionado).
...
=== "Reemplazar :material-file-replace:"
    ...
    1. Pasamos un [iterable](../../../fundamentos/modularidad/poo.md#iterables) de objetos.
...
=== "Consultar :material-magnify:"
    ...
    1. También se puede aplicar [`filter()`](#ciertos-objetos), [`get()`](#un-unico-objeto) o [`exclude()`](#excluyendo-objetos).
...
!!! info "Interfaz administrativa"
    ...
    Para habilitar modelos «muchos a muchos» en la interfaz administrativa [consulta esta documentación](admin.md#relaciones-muchos-a-muchos).
...
1. Esta [clave ajena](#claves-ajenas) proviene del modelo `Post`.
2. Esta [clave ajena](#claves-ajenas) proviene del modelo `Label`.
...
5.  - De esta forma sólo permitimos una única razón de etiquetado (por «post» y etiqueta).
    - Consulta [valores únicos juntos](#valores-unicos-juntos).
...
=== "Reemplazar :material-file-replace:"
    ...
    2. Pasamos un [iterable](../../../fundamentos/modularidad/poo.md#iterables) de objetos.
    3.  - Especificamos el/los campo(s) de la relación intermedia.
        - No es necesario añadir `labeled_at` ya que se almacena automáticamente gracias a `auto_now_add`.
...
!!! info "Interfaz administrativa"
    ...
    Para habilitar modelos «muchos a muchos» en la interfaz administrativa [consulta esta documentación](admin.md#relaciones-muchos-a-muchos-con-modelo-intermedio).

## Campos de fichero

<span class="dj-level">:material-signal-cellular-2: Django intermedio</span>

Entre los distintos [campos](#campos) que podemos utilizar en un modelo Django están los **campos de fichero** que permiten almacenar (vincular) un fichero a un objeto.
...
Si es tu caso, debes agregar la siguiente configuración en las [URLs de primer nivel](urls.md#urls-de-primer-nivel):
...
En este caso vamos a poner el <span class="example">ejemplo:material-flash:</span> de añadir un «post» que tiene imagen de portada («cover») utilizando un [formulario de modelo](formularios.md#formularios-de-modelo) para ello:
...
1. La función [reverse](urls.md#url-desde-nombre) ya nos devuelve la URL correspondiente.

### URL canónica en vistas

Además de las [redirecciones](urls.md#redireccion) ya vistas, Django nos permite hacer una redirección sobre una instancia de un modelo. En ese caso se usará la URL canónica del objeto como URL de destino.
...
1.  - Django obtiene la URL llamando a [`post.get_absolute_url()`](modelos.md#url-canonica) y hace la redirección.
...
Hemos visto ya [cómo ordenar resultados de consultas](#ordenando-resultados) pero Django también ofrece la posibilidad de definir una **ordenación por defecto** para los modelos.
...
:material-check-all:{ .blue } Por supuesto esta ordenación por defecto siempre puede ser "invalidada" por un [`order_by()`](#ordenando-resultados) explícito.
...
=== "`m2m_changed`"
    ...
    [Esta señal](https://docs.djangoproject.com/en/stable/ref/signals/#m2m-changed) se lanza al modificar un campo [`ManyToManyField`](#relaciones-muchos-a-muchos) de una instancia de modelo.
    ...
    ??? info "Parámetros"
        ...
        - `sender`: Clase de [modelo intermedio](#relaciones-muchos-a-muchos-con-modelo-intermedio).
...
4. Importamos la función que [envía correos](extras.md#enviar-correo) (_ficticio, sólo a efectos de demostración_).
...
:one: [Validación individual](#validacion-individual)  
:two: [Validación cruzada](#validacion-cruzada)
...
!!! warning "Comportamiento de los validadores"
    ...
    Los validadores **no se ejecutan** cuando guardamos «directamente» un modelo, sólo se ejecutan cuando creamos [formularios de modelo](formularios.md#formularios-de-modelo) y tratamos de guardar una instancia del mismo.
...
Efectivamente el fichero generado [`posts.json`](files/modelos/posts.json) es un JSON:
...
Así, por <span class="example">ejemplo:material-flash:</span>, podríamos obtener todos los «posts» de nuestra base de datos mediante una [consulta](#recuperando-objetos) en el ORM con `#!python Post.objects.all()`.

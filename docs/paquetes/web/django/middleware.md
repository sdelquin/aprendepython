...
=== "Plantilla"
    ...
    :material-check-all:{ .blue } El bloque de mensajes `#!html <ul>...</ul>` es apropiado para [incluirlo](plantillas.md#inclusion) en plantillas base.

## Middleware personalizado

<span class="dj-level">:material-signal-cellular-3: Django avanzado</span>

Más allá de los [«middleware» existentes](#middleware-disponible) en Django, es posible implementar un «middleware» personalizado para aquellas tareas que sean necesarias aplicar de manera global en el ciclo petición/respuesta.

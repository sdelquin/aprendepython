...
Si hemos [creado el proyecto](arranque.md#creacion-del-proyecto) Django con la carpeta base `main` podremos encontrar las **URLs de primer nivel** en el fichero `main/urls.py`.
...
Lo primero será modificar el fichero de configuración de las [URLs de primer nivel](#urls-de-primer-nivel) para añadir la delegación a la aplicación correspondiente:
...
=== "Conversor"
    ...
    3. Hay que especificar la [expresión regular](../../../libreria/texto/re.md) que captura el patrón en la URL.
    4.  - Este método convierte el patrón capturado `#!python str` en el objeto correspondiente.
        - URL :material-arrow-right-thin: Python
    5. Ver [consulta no encontrada](vistas.md#consulta-no-encontrada).
...
=== "URL con parámetros"
    ...
    1. Aproximación usando [parámetros posicionales](../../../fundamentos/modularidad/funciones.md#argumentos-posicionales).
    2. Aproximación usando [parámetros nominales](../../../fundamentos/modularidad/funciones.md#argumentos-nominales).

## Accesos directos en primer nivel

<span class="dj-level">:material-signal-cellular-2: Django intermedio</span>

En las [URLs de primer nivel](#urls-de-primer-nivel) podemos ir más allá del típico «include». En este sentido se abren varias posibilidades:
...
1.  - Simulamos una vista mediante una función [lambda](../../../fundamentos/modularidad/funciones.md#funciones-anonimas-lambda).
...
=== "posts/urls.py"
    ...
    3.  - Es conveniente usar [cadenas en crudo](../../../fundamentos/tipos/cadenas.md#cadenas-en-crudo) para las expresiones regulares.

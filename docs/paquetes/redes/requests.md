...
En una petición GET podemos incluir parámetros en el llamado «query string». Los parámetros se definen mediante un [diccionario](../../fundamentos/estructuras/diccionarios.md) con nombre y valor de parámetro.
...
El procedimiento que utilizamos es descargar el contenido desde la url y [volcarlo a un fichero](../../fundamentos/estructuras/ficheros.md#escritura-de-un-fichero) de manera estándar:
